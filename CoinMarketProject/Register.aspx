    ...
    <form id="form1" runat="server">
        <div class="login-container">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="ApiKeyTextBox" runat="server" CssClass="form-control" placeholder="API Key"></asp:TextBox>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="FullNameTextBox" runat="server" CssClass="form-control" placeholder="Tam Adı"></asp:TextBox>
            </div>
            <asp:Button ID="RegisterButton" runat="server" Text="Kayıt Ol" CssClass="btn btn-primary" OnClick="RegisterButton_Click" />
            <asp:Button ID="ReturnLogin" runat="server" Text="Giriş Yap" CssClass="btn btn-primary" OnClick="ReturnLoginButton_Click" />
